...
public class DBHelper extends SQLiteOpenHelper {
    ...
    // Tabel Cart Header
    public static final String TABLE_CART_HEADER = "CartHeader";
    public static final String CART_ID = "CartID";

    public static String SQL_CREATE_CART_HEADER_TABLE =
            "CREATE TABLE IF NOT EXISTS " + TABLE_CART_HEADER + "(" +
                    CART_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
                    USER_ID + " INTEGER, " +
                    " FOREIGN KEY (" + USER_ID + ") REFERENCES " + TABLE_USERS + "(" + USER_ID + ")" +
                    ")";

    public static String SQL_DROP_CART_HEADER_TABLE =
            "DROP TABLE IF EXISTS " + TABLE_CART_HEADER;
    ...
    //Tabel Cart Detail
    public static final String TABLE_CART_DETAIL = "CartDetail";
    public static final String QUANTITY = "Quantity";

    public static String SQL_CREATE_CART_DETAIL_TABLE =
            "CREATE TABLE IF NOT EXISTS " + TABLE_CART_DETAIL + "(" +
                    CART_ID + " INTEGER," +
                    SNACK_ID + " INTEGER," +
                    QUANTITY + " INTEGER, "+
                    " FOREIGN KEY (" + CART_ID + ") REFERENCES " + TABLE_CART_HEADER + "(" + CART_ID + ")," +
                    " FOREIGN KEY (" + SNACK_ID + ") REFERENCES " + TABLE_SNACKS + "(" + SNACK_ID + ")," +
                    "PRIMARY KEY (" + CART_ID + ", " + SNACK_ID + ")" +
                    ")";

    public static String SQL_DROP_CART_DETAIL_TABLE =
            "DROP TABLE IF EXISTS " + TABLE_CART_DETAIL;
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(SQL_CREATE_CART_HEADER_TABLE);
        db.execSQL(SQL_CREATE_TRANSACTION_DETAIL_TABLE);
        db.execSQL(SQL_CREATE_CART_DETAIL_TABLE);
    }

    @Override
    public void onUpgrade(SQLiteDatabase db, int OldVersion, int NewVersion) {
        db.execSQL(SQL_DROP_TRANSACTION_DETAIL_TABLE);
        db.execSQL(SQL_DROP_CART_DETAIL_TABLE);
        db.execSQL(SQL_DROP_CART_HEADER_TABLE);
