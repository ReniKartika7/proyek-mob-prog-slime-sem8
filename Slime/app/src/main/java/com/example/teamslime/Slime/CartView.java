...
import com.example.teamslime.Slime.adapter.CartAdapter;
...
public class CartView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textMyCartCountProduct.setText(CartDB.currentCart.size() + " PRODUCT(S) CHOSEN");
        ...
        textMyCartPriceTotal.setText("Rp" + totalPrice);
