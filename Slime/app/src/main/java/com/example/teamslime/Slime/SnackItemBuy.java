...
public class SnackItemBuy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.get().load(url).placeholder(R.drawable.loading_progressbar).error(R.drawable.ic_error).resize(200,200).into(imageSnackBuy);
        ...
        buttonAddNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Picasso.get().load(url).placeholder(R.drawable.loading_progressbar).error(R.drawable.ic_error).resize(200,200).into(imageAddCartPopUp);
        ...
        buttonBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Picasso.get().load(url).placeholder(R.drawable.loading_progressbar).error(R.drawable.ic_error).resize(200,200).into(imageBuyNowPopUp);
